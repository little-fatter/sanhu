                ...
                try
                {
                    ...
                    try
                    {
                        using (IDbCommand command = this.CreateCommand(this._sharedConnection, sql, args))
                        {
                            ...
                            if ((underlyingType != null) && ((rev == null) || Convert.IsDBNull(rev)))
                            {
                                return default(T);
                            }
                            local = (T)Convert.ChangeType(rev, (underlyingType == null) ? typeof(T) : underlyingType);
                        }
                    }
                    finally
                    {

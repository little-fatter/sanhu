...
{
    public class stock_pileDetail : ServiceBase, IService
    {

        public stock_pileDetail()
        {
            OnGetPagedData += stock_pileDetail_OnGetPagedData;
        }

        void stock_pileDetail_OnGetPagedData(object data)
        {
            var db = this.MainDb;

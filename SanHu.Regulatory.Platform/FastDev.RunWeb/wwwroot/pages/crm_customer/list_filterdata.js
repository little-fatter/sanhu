...
function() {
    ...
    var exports = {
        type: 'list',
        options: view(),
        dataset: 'web/dataset?model=crm_customer&viewname=list_filterdata'
    };
    ...
    exports.service = function service(page) {
        ...
        function(e) {
            ...
            p.bind = {
                filterData: {
                    rules: [{
                        field: 'id in (select CustomerID from crm_customerContract where CreateDate < DATEADD(month, -3, getDate()) )',
                        type: 'sql'
                    }]
                }
            };

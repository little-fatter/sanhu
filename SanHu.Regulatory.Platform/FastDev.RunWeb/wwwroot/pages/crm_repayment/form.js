...
function() {
    ...
    var exports = {
        ...
        dataset: 'web/dataset?model=crm_repayment&viewname=form'
    };
    ...
    exports.service = function server(page) {
        ...
        function(e) {
            ...
            p.toSave = function(postdata, callback) {
                ...
                var message = "将汇款" + amount + "(" + changeNumMoneyToChinese(amount) + ")给" + postdata.Customer[1];

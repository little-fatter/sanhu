define([
   "jquery",
   "text!pages/application/index2/index.html",
   "home",
], function ($,html,common)
{
    ...
    function main(homeData)
    {
        ...
        $("#header .viewedit").click(function () {
        ...
        {
            openTab({
            	url: 'pages/application/home/vieweditor.w#welcome/hello',
                text: '编辑视图',
                showClose: false,
                tabid: 'vieweditor'
            });
        ...
        require(["Scripts/jquery-ui/ui/i18n/jquery.ui.datepicker-zh-CN.js"], function () { });
                ...
                if (groups && groups.length)
                {
                    ...
                    for (var gi = 0; gi < groups.length; gi++)
                    {
                        ...
                        $(items).each(function (i, submenu)
                        {
                            ...
                            var subitem = $('<li><a class="menulink link" href="javascript:void(0)" data-url="' + url + '" ></a></li>');
                            subitem.find("a").attr({

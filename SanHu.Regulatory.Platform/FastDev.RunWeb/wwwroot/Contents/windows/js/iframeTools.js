(function (g, k, a, f)
{
    ...
    c = "@ARTDIALOG.OPEN",
    e = "@ARTDIALOG.OPENER",
    h = k.name = k.name || "@ARTDIALOG.WINNAME" + (new Date).getTime(),
    ...
    a.prompt = function (o, q, p)
    {
        ...
        return i({
            ...
            min: false,
            opacity: 0.1,
            content: ['<div style="margin-bottom:5px;font-size:12px">', o, "</div>", "<div>", '<input value="', p, '" style="width:18em;padding:6px 4px" />', "</div>"].join(""),
            init: function ()
            {

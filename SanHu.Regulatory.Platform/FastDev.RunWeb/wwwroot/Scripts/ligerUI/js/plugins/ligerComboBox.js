...
(function ($)
{
    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            {
                g.valueField = $(this.element).hide();
            ...
            {
                g.trigger('changeText', g.inputText.val());
            });
        ...
        _setValue: function (value, text)
        {
            ...
            else if (p.setTextBySource)
            {
                if ($.isFunction(p.setTextBySource))
                {
                    if (p.setTextBySource(p))
                    {
                    ...
                    if (g.trigger('beforeSetData', [data]) == false)
{
        ...
        _dataInit: function ()
        {
            ...
            if (p.initValue != null)
            {
                ...
                else if (g.data && !p.isTextBoxMode)
                {
        ...
        _changeValue: function (newValue, newText,isSelectEvent)
        {
            ...
            if (p.isTextBoxMode)
            {
                g.valueField.val(newValue || newText);
                g.trigger('changeValue', [newText]);
                g.trigger('changeText', [newText]);
                return;
            }
            g.valueField.val(newValue);
            if (g.select)
            ...
            if (isSelectEvent)
            {
                if (p.tree) rowData = rowData || g.selectedTreeData;
    ...
    (function ()
    {
        ...
        $(document).bind('keydown.ligercombobox',function (event)
        {
            ...
            if (curInput.length && curInput.attr && curInput.attr("data-comboboxid"))
            { 

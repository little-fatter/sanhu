...
(function() {
  ...
  MT("x霉/ msgenny keywords classify as 'keyword'",
    "[keyword watermark]",
  ...
  MT("x霉/ msgenny constants classify as 'variable'",
    "[variable auto]",
  ...
  MT("within an attribute list, mscgen/ x霉 attributes classify as base",
    "[base [[label]",
    "[base idurl id url]",
  ...
  MT("outside an attribute list, mscgen/ x霉 attributes classify as base",
    "[base label]",
    "[base idurl id url]",
    "[base linecolor linecolour textcolor textcolour textbgcolor textbgcolour]",
    "[base arclinecolor arclinecolour arctextcolor arctextcolour arctextbgcolor arctextbgcolour]",

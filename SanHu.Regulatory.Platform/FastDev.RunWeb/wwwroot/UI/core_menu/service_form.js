function server(page)
{
    ...
    page.bind('beforeShowForm', function (e)
    {
        ...
        var page = e.page;
        var op = e.options;  
        var field1 = pbc.web.helper.first(op.fields, function (a) { return a.name == "MenuUrl"; });
        var field2 = pbc.web.helper.first(op.fields, function (a) { return a.name == "MenuUrlBind"; });

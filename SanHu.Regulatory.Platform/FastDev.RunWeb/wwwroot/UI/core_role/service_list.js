function server(page)
{
    ...
    $.extend(events,
    {
        ...
        toolbarInit: function (e)
        {
            ...
            var roleId = null, userId = null; 

            page.addEvent("rights", function ()
            {
                ...
                pbc.web.loader(["treeEditor","grid"], function ()
                {
                    getModel();
                });
            });
            ...
            { 
                ...
                function getGridData(field)
                {
                    ...
                    $(grid.rows).each(function ()
                    {
                        ...
                        if (field == "funRights")
                        {
                            var chklist = pbc.web.helper.first(grid.chklist, function (a) { return a.id == row.modelName; }).list;

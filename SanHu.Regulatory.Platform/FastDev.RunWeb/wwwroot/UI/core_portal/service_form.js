function server(page)
{
    ...
    page.bind('beforeShowForm', function (e)
    {
        ...
        var field1 = pbc.web.helper.first(op.fields, function (a) { return a.name == "Link"; });
        ...
        if (field2 != null && field2.editor)
        {
            field2.editor.onButtonClick = function ()
            {
                ...
                pbc.getFilterFields(getUrlParm(combobox_url.getValue(), "model"), function (filterFields)
                {
                    var filterData;

<template>
  <page-layout title="单号：234231029431">

    <detail-list slot="headerContent" size="small" :col="2" class="detail-layout">
      <detail-list-item term="创建人">周星星</detail-list-item>
    ...
    <a-card style="margin-top: 24px" :bordered="false" title="用户信息">
      <detail-list>
        <detail-list-item term="用户姓名">周星星</detail-list-item>
        ...
        <detail-list-item term="联系地址">成都市XXX</detail-list-item>
      </detail-list>
      ...
      <a-card type="inner" title="多层信息组">
        <detail-list title="组名称" size="small">
          <detail-list-item term="负责人">周星星</detail-list-item>

  ...
  <div class="wrapper">
    ...
    <div class="content">
      <div class="box">
        ...
        <a-row class="row">
          <a-col class="colSize colLine" :span="4">是否涉嫌犯罪：</a-col>
          <a-col class="colSize contentColor" :span="12">
            {{ loadData.ExistCrim === 0 ? '否' : '是' }}
          </a-col>
        </a-row>
        <!-- <a-row class="row">
      ...
      <div class="box border" v-if="fileData.length > 0">
        <a-row class="row">
...
<script>
import PartyView from '../case/components/partyView'
    ...
    init () {
      ...
      getFormDetail('task_survey', null, id).then(res => {
        if (res) {
          ...
          console.log(this.loadData.LawParties)
        }
      })
    },
    // 获取事件信息
